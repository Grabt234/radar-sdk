...
class Population:
    ...
    def __init__(
        ...
        for _ in range(self.pop_size):
            chromosomes = [
                Chromosome(header, min_val, max_val, num_values_per_chrom)
    ...
    def fill(self) -> None:
        ...
        while len(self._organisms) < self.pop_size:
            fresh_chromosomes = [
                Chromosome(h, self._min_val, self._max_val, self._num_values)
    ...
    def propagate(self, fitness_fn: Callable[[Organism], float]) -> None:
        ...
        #print(f"start {self._organisms[0]._id}")
